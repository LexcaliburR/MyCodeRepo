...
template <typename T>
// T single_box_iou_rotated(T const* const box1_raw, T const* const box2_raw) {
T single_box_iou_rotated(const Box& box1_raw, const Box& box2_raw) {
    RotatedBox<T> box1, box2;

    auto center_shift_x = (box1_raw.cx + box2_raw.cx) / 2.0;
    auto center_shift_y = (box1_raw.cy + box2_raw.cy) / 2.0;

    box1.x_ctr = box1_raw.cx - center_shift_x;
    box1.y_ctr = box1_raw.cy - center_shift_y;
    box1.w = box1_raw.w;
    box1.h = box1_raw.l;
    box1.a = box1_raw.a;

    box2.x_ctr = box2_raw.cx - center_shift_x;
    box2.y_ctr = box2_raw.cy - center_shift_y;
    box2.w = box2_raw.w;
    box2.h = box2_raw.l;
    box2.a = box2_raw.a;
