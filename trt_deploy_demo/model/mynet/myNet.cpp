 ...
 * @LastEditTime: 2021-12-07 14:45:19
 */
#include "myNet.h"

#define LOG(i) std::cout << " step " << i << std::endl;
...
bool MyNet::constructNetwork(SampleUniquePtr<nvinfer1::IBuilder>& builder,
